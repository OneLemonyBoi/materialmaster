package onelemonyboi.materialmaster;

import onelemonyboi.materialmaster.api.MaterialMasterReference;
import onelemonyboi.materialmaster.api.PropertyProviderUtils;
import onelemonyboi.materialmaster.api.core.ModSyncManager;
import onelemonyboi.materialmaster.api.core.PropertySyncManager;
import onelemonyboi.materialmaster.client.handler.AttackIndicatorHandler;
import onelemonyboi.materialmaster.client.handler.ItemTooltipHandler;
import onelemonyboi.materialmaster.common.handler.DigSpeedHandler;
    ...
    private void onInterModProcess(final InterModProcessEvent evt) {
        ...
        messages.stream()
                ...
                .forEach(message -> {
                    ...
                    InterModComms.sendTo(MaterialMaster.MODID, message.getSenderModId(), MaterialMasterReference.RETURN_CONFIG_EVENT,
                            () -> (Consumer<ModConfig.Reloading>) PropertySyncManager.getInstance()::onModConfig);
                });
        ...
        messages.stream()
                ...
                .forEach(message -> {
                    ...
                    InterModComms.sendTo(MaterialMaster.MODID, message.getSenderModId(), MaterialMasterReference.RETURN_CONFIG_EVENT,
                            () -> (Consumer<ModConfig.Reloading>) ModSyncManager.getInstance()::onModConfig);
                });
    }
